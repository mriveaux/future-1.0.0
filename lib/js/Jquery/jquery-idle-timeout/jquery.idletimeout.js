...
(function ($, win) {
    var idleTimeout = {
        ...
        _keepAlive: function (recurse) {
            ...
            Ext.Ajax.request({
                url: options.keepAliveURL, method: 'POST',
                ...
                callback: function (options, success, response) {
                    ...
                    if (responseData.total) {
                        ...
                        self.failedRequests--;
                        // MensajeError('Error al procesar las notificaciones.<br>P&oacute;ngase en contacto con el administrador del sistema.');
                    }
                    if (recurse) {
                        self._startTimer();
                    }
    ...
    $.idleTimeout.options = {
        ...
        // user is considered idle after this many seconds.  14 minutes : 30 seconds default
        idleAfter: 840,
        // a polling request will be sent to the server every 600 seconds = 10 min
        pollingInterval: 180,
        ...
        titleMessage: 'Advertencia: %s segundos para salir | ',
        /*
         Callbacks
