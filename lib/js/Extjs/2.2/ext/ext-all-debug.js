...
Ext.BoobbleMsg=function(){var e;function c(a,b,f){return['<div class="msg">','<div class="x-box-tl"><div class="x-box-tr"><div class="x-box-tc"></div></div></div>','<div class="x-box-ml"><div class="x-box-mr"><div class="x-box-mc"><h3>',a,'</h3><span class="'+f+'"></span>',b,"</div></div></div>",'<div class="x-box-bl"><div class="x-box-br"><div class="x-box-bc"></div></div></div>',"</div>"].join("")}function d(a,b,f){return['<div class="msg">','<div class="x-box-tl" style="border:2px solid #D61C02;border-bottom:0;"><div class="x-box-tr"><div class="x-box-tc"></div></div></div>','<div class="x-box-ml" style="border-left:2px solid #D61C02"><div class="x-box-mr" style="border-right:2px solid #D61C02"><div class="x-box-mc"><h3 style="color:#D61C02;">',a,'</h3><span class="'+f+'"></span>',b,"</div></div></div>",'<div class="x-box-bl" style="border:2px solid #D61C02;border-top:0;"><div class="x-box-br"><div class="x-box-bc"></div></div></div>',"</div>"].join("")}return{msg:function(n,b,p){if(!e){e=Ext.DomHelper.insertFirst(document.body,{id:"msg-div"},true)}e.alignTo(document,"t-t");var a=String.format.apply(String,Array.prototype.slice.call(arguments,1));var j=Ext.DomHelper.append(e,{html:(p==Ext.MessageBox.ERROR)?d(n,a,p):c(n,a,p)},true);stringL=b.toString();msgLength=stringL.length;var q=0;for(var h=0;h<stringL.length;h++){if(stringL.charAt(h)=="&"){q+=7}}if(q>0){msgLength-=q}var o=0;if(msgLength<50){o=2}else{if(msgLength<60){o=3}else{o=4}}var f=parseFloat(document.getElementById("msg-div").style.left);document.getElementById("msg-div").style.left=(f*2)-10+"px";j.slideIn("r").pause(o).ghost("r",{remove:true})}}}();
