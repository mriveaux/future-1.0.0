...
if (!Ext.grid)
    Ext.ns('Ext.grid');
Ext.grid.Pivot = Ext.extend(Ext.util.Observable, {
    ...
    viewConfig: {
        ...
        renderHeaders: function () {
            ...
            for (var row = 0, rlen = rows.length; row < rlen; row++) {
                ...
                for (var i = 0, gcol = 0, len = r.length; i < len; i++) {
                    ...
                    var id = this.getColumnId(group.dataIndex ? cm.findColumnIndex(group.dataIndex) : gcol), gs = Ext.grid.Pivot.prototype.getGroupStyle.call(this, group, gcol);
        ...
        onColumnWidthUpdated: function () {
            ...
            Ext.grid.Pivot.prototype.updateGroupStyles.call(this);
        },
        ...
        afterRenderUI: function () {
            ...
            Ext.apply(this.columnDrop, Ext.grid.Pivot.prototype.columnDropConfig);
            Ext.apply(this.splitZone, Ext.grid.Pivot.prototype.splitZoneConfig);
        }
    },
    splitZoneConfig: {
    ...
    columnDropConfig: {
        ...
        positionIndicator: function (h, n, e) {
            var data = Ext.grid.Pivot.prototype.getDragDropData.call(this, h, n, e);
            if (data === false) {
                return false;
            }
        ...
        onNodeDrop: function (n, dd, e, data) {
            var h = data.header;
            if (h != n) {
                var d = Ext.grid.Pivot.prototype.getDragDropData.call(this, h, n, e);
                if (d === false) {
                    return false;
                }
            ...
            if (row < rows.length) {
                ...
                for (var i = 0, gcol = 0; i < cells.length; i++) {
                    ...
                    if ((typeof col != 'number') || (col >= gcol && col < gcol + group.colspan)) {
                        var gs = Ext.grid.Pivot.prototype.getGroupStyle.call(this, group, gcol);
    ...
    getDragDropData: function (h, n, e) {
        ...
        var row = Ext.grid.Pivot.prototype.getGroupRowIndex.call(this.view, h),
                oldGroup = Ext.grid.Pivot.prototype.getGroupSpan.call(this.view, row, oldIndex),
                newGroup = Ext.grid.Pivot.prototype.getGroupSpan.call(this.view, row, newIndex),
        ...
        var parentGroup = Ext.grid.Pivot.prototype.getGroupSpan.call(this.view, row - 1, oldIndex);
