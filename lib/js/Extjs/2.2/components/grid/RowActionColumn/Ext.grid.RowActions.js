 ...
 */
Ext.grid.RowActions = function(config) {
    ...
    // call parent
    Ext.grid.RowActions.superclass.constructor.call(this);
};

Ext.extend(Ext.grid.RowActions, Ext.util.Observable, {
     ...
     *   {Function} <strong>callback</strong> (optional). Function to call if the action icon is clicked.
     ...
     * </li>
     * <li style="list-style-position:outside">
     *   {Function} <strong>cb</strong> Shortcut for callback.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>iconIndex</strong> Optional, however either iconIndex or iconCls must be
     *   configured. Field name of the field of the grid store record that contains
     *   css class of the icon to show. If configured, shown icons can vary depending
     *   of the value of this field.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>iconCls</strong> CSS class of the icon to show. It is ignored if iconIndex is
     *   configured. Use this if you want static icons that are not base on the values in the record.
     * </li>
     * <li style="list-style-position:outside">
     *   {Boolean} <strong>hide</strong> Optional. True to hide this action while still have a space in
     *   the grid column allocated to it. IMO, it doesn't make too much sense, use hideIndex instead.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>hideIndex</strong> Optional. Field name of the field of the grid store record that
     *   contains hide flag (falsie [null, '', 0, false, undefined] to show, anything else to hide).
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>qtipIndex</strong> Optional. Field name of the field of the grid store record that
     *   contains tooltip text. If configured, the tooltip texts are taken from the store.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>tooltip</strong> Optional. Tooltip text to use as icon tooltip. It is ignored if
     *   qtipIndex is configured. Use this if you want static tooltips that are not taken from the store.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>qtip</strong> Synonym for tooltip
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>textIndex</strong> Optional. Field name of the field of the grids store record
     *   that contains text to display on the right side of the icon. If configured, the text
     *   shown is taken from record.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>text</strong> Optional. Text to display on the right side of the icon. Use this
     *   if you want static text that are not taken from record. Ignored if textIndex is set.
     * </li>
     * <li style="list-style-position:outside">
     *   {String} <strong>style</strong> Optional. Style to apply to action icon container.
     * </li>
     * </ul>
     */
    ...
    actionEvent: 'click'
             ...
             * <ul class="list">
             * <li style="list-style-position:outside">
             *   {String} <strong>align</strong> Set it to 'left' to place action icon next to the group header text.
            ...
            '<div class="">'
              + '<tpl for="actions">'
              + '<div id = "{id}" class="ux-row-action-item {cls} <tpl if="text">'
    ...
    , processActions: function(actions, template) {
        ...
        Ext.each(actions, function(a, i) {
            ...
            o.style += 'display:inline-block;cursor:pointer;';
            if (i) {
                o.style += a.marginLeft ? 'margin-left:' + a.marginLeft + 'px;' : 'margin-left:5px;';
            }
            if (a.icon) {
                o.style += (a.width && a.height) ? 'width:' + a.width + 'px;height:' + a.height + 'px;' : 'width:16px;height:16px;';
                o.style += 'background-image: url(' + a.icon + ');';
            }
            if (a.id) {
                o.id = a.id;
            }
    ...
    , onClick: function(e, target) {
        ...
        if (false !== row && false !== col && false !== action) {
            ...
            if (true !== this.eventsSuspended && false === this.fireEvent('beforeaction', this.grid, record, action, row.rowIndex, col)) {
                ...
                this.fireEvent('action', this.grid, record, action, row.rowIndex, col, e);
            }
