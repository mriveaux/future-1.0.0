...
/** 
 * @class Ext.form.ItemSelector
 * @extends Ext.form.Field
 * A control that allows selection of between two Ext.form.MultiSelect controls.
 * 
 *  @history
...
Ext.form.ItemSelector = Ext.extend(Ext.form.Field, {
    msWidth: 200,
    msHeight: 300,
    hideNavIcons: false,
    imagePath: "",
...
//          Ext.form.ItemSelector.superclass.initComponent.call(this);
        this.addEvents({
            'rowdblclick': true,
            'change': true
        });
        return Ext.form.ItemSelector.superclass.initComponent.call(this);
    },
    onRender: function (ct, position) {
        Ext.form.ItemSelector.superclass.onRender.call(this, ct, position);

        this.fromMultiselect = new Ext.form.MultiSelect({
        ...
        this.toMultiselect = new Ext.form.MultiSelect({
    ...
    onRowClick: function (vw, index, node, e) {
        return this.fireEvent('rowdblclick', vw, index, node, e);
    },
    reset: function () {
...
Ext.reg("itemselector", Ext.form.ItemSelector);