...
Ext.define("Ext.locale.en.comun.PrintView", {
    ...
    lbExcel: 'Sheet',
    lbTtAceptar: 'Accept configuration and show the type of report.',
...
Ext.define("Ext.locale.en.Feet.PagingToolbar", {
...
Ext.define("Ext.locale.en.ux.form.SearchField", {
...
Ext.define("Ext.locale.en.grid.RowEditor", {
    ...
    saveBtnText: '<i class="fa fa-check-circle green-button"></i> <b>Ok</b>',
    cancelBtnText: '<i class="fa fa-times-circle red-button"></i> <b>Cancel</b>',
    errorsText: "Errors",
