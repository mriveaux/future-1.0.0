/* global Ext */
Ext.define('Categoriacliente.store.Sector', {
    extend: 'Ext.data.Store',
    storeId: 'Sector',
    model: 'Categoriacliente.model.Sector',
    autoLoad: true, autoSync: true, filterOnLoad: false,
    proxy: {
        type: 'ajax',
        actionMethods: {read: 'POST'},
        extraParams: {restful: true},
        api: {read: 'loaddatasector'},
            ...
            exception: function(proxy, response, operation) {
                ...
                if (response.codMsg == 2) {
                    ...
                    switch (operation.action) {
                        case 'create':
                            msg = futureLang.lbAddExisteSector;
                            break;
                        case 'update':
                            msg = futureLang.lbModExisteSector;
                            break;
                        case 'destroy':
