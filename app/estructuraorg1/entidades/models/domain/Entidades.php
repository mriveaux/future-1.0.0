...
class Entidades extends Doctrine_Record {
    ...
    public function setTableDefinition() {
        ...
        $this->hasColumn('idterritorio', 'numeric', null, array('notnull' => false, 'primary' => false));
    ...
    static public function cargarEntidades($post) {
        try {
            $idpadre = $post->node;
...
//            }
    ...
    static public function buscarEntidadesNombre($nombre, $id = 0) {
        try {
