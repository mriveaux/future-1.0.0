...
Ext.extend(Ext.ux.StartMenu, Ext.menu.Menu, {
    ...
    render: function() {
        ...
        var divProfile = this.toolsPanel.createChild({
            tag: "div",
            cls: "user-profile-container"
        });
        var img_panel_container = divProfile.createChild({
            tag: "div",
            cls: "user-profile"
        });
        var photoPerfil = new Ext.Panel({
            width: 100,
            height: 100,
            html: '<img width=100 height=100 src=' + this.src + '>'
        });
        photoPerfil.render(img_panel_container);
        ...
        this.menuBWrap.setHeight(350); // Tamanno del menu general ((this.height)se le pasa 300)
