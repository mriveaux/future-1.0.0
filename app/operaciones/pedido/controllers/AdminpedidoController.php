...
class AdminpedidoController extends ControllerSecure {
...
//        $this->_integrator->setModels('comercial', 'Cliente'); //Cliente		
    ...
    public function adminpedidoAction() {
        $this->render('adminpedido');
    }
    ...
    public function importarpedidosAction() {
        echo json_encode($this->PedidoModel->ImportarPedidos(json_decode($this->dataPost->pedidos)));
    }

    public function cambiarestadoAction() {
        echo json_encode($this->PedidoModel->cambiarEstado($this->dataPost));
    }
