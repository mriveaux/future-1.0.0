...
class InstallModel extends ModelSecure {
    ...
    private function createRegisterFile($argParams, $serialData) {
        $config_file = $_SERVER['DOCUMENT_ROOT'] . "/comun/license.key";

        $file = fopen($config_file, 'w');
        $content = "============================================================\n"
                . "Nombre del producto: " . $argParams['productname'] . "\n"
                . "Empresa: " . $argParams['enterprisename'] . "\n"
                . "N�mero de serie: " . $argParams['serial'] . "\n"
                . "V�lido por: " . $serialData->validDays . "\n"
                . "Fecha de registro: " . $serialData->registerDate . "\n"
                . "Fecha de caducidad: " . $serialData->endDate . "\n"
                . "============================================================\n"
                . "C�digo de registro: " . $this->generateRegisterToken($serialData->endDate);
        fwrite($file, $content);
        fclose($file);
    }
