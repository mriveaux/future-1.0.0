...
require_once($_SERVER['DOCUMENT_ROOT'] . '/lib/php/Exception/Logger.php');
require_once($_SERVER['DOCUMENT_ROOT'] . '/lib/php/Exception/ExceptionMt.php');
try {
    ...
    Logger::writeLogException($e, TRUE);
}
